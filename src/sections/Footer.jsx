...
const glowVariants ={
  ...
  hover : {
    ...
    transition :{ type : "sprig", stiffness : 300, damping:15}
  },
     ...
     >
      ...
      <div className=" flex gap-5 text-2xl md:text-3xl">
        {socials.map(({Icon, label, href})=>(
          ...
          whileHover="hover"
          whileTap="tap"
          className="text-gary-300 transition-colors duration-200 inline-flex items-center justify-center"
          >
            <Icon/>
          </motion.a>
        ))} 
      ...
      <p className=" text-gray-400 text-xs">
        &copy; {new Date().getFullYear()} Avdhut Patole. All rights reserved. 
      </p>
