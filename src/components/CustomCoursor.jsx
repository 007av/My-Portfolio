...
const CustomCoursor = () => {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener("mousemove", moveHandler); // to remove after unmount the Componnet
  });

  return (
    <div className=" pointer-events-none fixed top-0 left-0 z-9999"
    style={{transform : `translate(${position.x - 40}px , ${position.y - 40}px)`}} //coursor movment tracking sathi
    >
